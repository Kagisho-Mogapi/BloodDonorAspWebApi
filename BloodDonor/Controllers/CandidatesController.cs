...
namespace BloodDonor.Controllers
{
    ...
    {
        private readonly DonorsDbContext _context;

        public CandidatesController(DonorsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Candidate>> PostCandidate(Candidate candidate)
        {
          if (_context.Candidates == null)
          {
              return Problem("Entity set 'DonorsDbContext.Candidates'  is null.");
          }
